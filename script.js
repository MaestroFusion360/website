...
const translations = {
    ...
    ru: {
        ...
        "about-title": "Обо мне",
        "about-desc": "Инженер-программист ЧПУ и <strong>разработчик Fusion 360</strong>, увлеченный автоматизацией разработки УП для ЧПУ станков.",
        "tech-title": "Технологии",
        "tech-stack": "Основной стек:",
        "tech-other": "Другие инструменты и навыки:",
        "projects-title": "Проекты",
        "smartpost-title": "SmartPost",
        "smartpost-desc": "Мощный инструмент, который ускоряет <strong>генерацию УП</strong> и устраняет <strong>ограничение на смену инструмента</strong> в Fusion 360 Personal.",
        "smartpost-feature1": "<strong>Быстрый постпроцессинг</strong> – сокращение времени на настройку вывода УП.",
        ...
        "smartpost-feature3": "<strong>Улучшенная эффективность</strong> – упрощенная генерация УП.",
        "automation-title": "Automation",
