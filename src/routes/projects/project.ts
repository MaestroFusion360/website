  ...
  active: [
    {
      ...
      en: {
        title: 'svelte-comp',
        description: 'A compact, modular UI toolkit built on <strong>Svelte 5</strong> with styling powered by <strong>TailwindCSS</strong> and a clean layer of CSS variables. Components are predictable, lightweight, and self-contained - no global side effects',
        features: [
      ...
      ru: {
        title: 'svelte-comp',
        description: 'Компактная модульная библиотека UI-компонентов на <strong>Svelte 5</strong> со стилями на <strong>TailwindCSS</strong> и слоем CSS-переменных. Компоненты предсказуемые, легкие и самодостаточные - без глобальных сайд-эффектов',
        features: [
          '<strong>Svelte 5 Runes API</strong> ($state, $derived, $effect, $props)',
    ...
    },
    {
      ...
      en: {
        title: 'Planner',
        description: 'Planner is a desktop application for <strong>manufacturing task management</strong> and <strong>production scheduling</strong>',
        features: [
      ...
      ru: {
        title: 'Planner',
        description: 'Planner — настольное приложение для <strong>управления производственными задачами</strong> и <strong>планирования производства</strong>',
        features: [
    ...
    },
    {
      ...
      en: {
        ...
        description: 'Easy G-Code Plot is a G-code editor and visualizer. It supports 3D rendering of toolpaths for <strong>3-axis milling</strong> and <strong>2-axis lathe</strong> machining with various modes',
        features: [
      ...
      ru: {
        title: 'Easy G-Code Plot',
        description: 'Easy G-Code Plot - редактор-визуализатор G-кода. Поддержка 3D прорисовки траекторий <strong>3х осевой фрезерной</strong> и <strong>2х осевой токарной</strong> обработки с различными режимами',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'SmartPost',
        description: 'A powerful tool that accelerates <strong>G-code generation</strong> and removes the <strong>tool change restriction</strong> in Fusion 360 Personal',
        features: [
      ...
      ru: {
        title: 'SmartPost',
        description: 'Мощный инструмент, который ускоряет <strong>генерацию УП</strong> и устраняет <strong>ограничение на смену инструмента</strong> в Fusion 360 Personal',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'FormBuilder',
        description: 'FormBuilder is a visual HTML form editor built with Svelte and Vite, offering developers a lightweight, dependency-free tool for complete control over form design',
        features: [
      ...
      ru: {
        title: 'FormBuilder',
        description: 'FormBuilder — это визуальный редактор HTML-форм на Svelte и Vite, предоставляющий разработчикам лёгкий инструмент без зависимостей для полного контроля над дизайном форм',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'CSS validator',
        description: '<strong>CSS Validator</strong> is a lightweight, interactive tool built with Svelte 5. It features a live editor with instant preview, inline validation',
        features: [
      ...
      ru: {
        title: 'CSS validator',
        description: '<strong>CSS Validator</strong> — это лёгкий интерактивный инструмент на Svelte 5. Он предлагает живой редактор с предпросмотром, встроенную валидацию',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'DrillCalc',
        description: '<strong>Drilling Calculator</strong> is a fast G-code coordinate generator for circular and grid hole patterns, designed for CNC machinists and Fusion 360 users',
        features: [
      ...
      ru: {
        title: 'DrillCalc',
        description: '<strong>Drilling Calculator</strong> — это быстрый генератор координат G-кода для круговых и сеточных массивов отверстий, созданный для операторов ЧПУ и пользователей Fusion 360',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'MoveOp',
        description: '<strong>MoveOp</strong> solves blocking operation in Fusion 360 after Import CAM Data',
        features: [
      ...
      ru: {
        title: 'MoveOp',
        description: '<strong>MoveOp</strong> решает блокировку операций в Fusion 360 после Import CAM Data',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'QuickSelect',
        description: '<strong>QuickSelect</strong> is a Fusion 360 add-in that simplifies the <strong>selection of tangent faces</strong> on your 3D models. With one click, the tool automatically selects:',
        features: [
      ...
      ru: {
        title: 'QuickSelect',
        description: '<strong>QuickSelect</strong> - это надстройка Fusion 360, которая упрощает <strong>выбор касательных граней</strong> в 3D-моделях. Одним кликом выбираются:',
        features: [
    ...
    },
    {
      ...
      en: {
        title: 'editor_json',
        description: '<strong>editor_json</strong> is a Progressive Web App (PWA) for managing CNC post-processor JSON files (@postprocessors_bot)',
        features: [
      ...
      ru: {
        title: 'editor_json',
        description: '<strong>editor_json</strong> — это веб-приложение (PWA) для управления JSON-файлами постпроцессоров ЧПУ (@postprocessors_bot)',
        features: [
