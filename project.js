  ...
  active: [
    ...
    },
    {
      ...
      en: {
        ...
        features: [
          ...
          "<strong>Drag-and-Drop<s/trong> & <strong>Keyboard Controls</strong>: Efficiently manage the layout using both mouse and keyboard shortcuts (Ctrl+Arrow keys).",
    ...
    },
    {
      ...
      en: {
        ...
        features: [
          "<strong>Edit post processor parameters<s/trong>",
